...
CREATE PROCEDURE [dbo].[sp_stg_maestros_02]
AS
BEGIN
  ...
  INSERT INTO MONEDAS
    ...
    FROM [10.110.21.9].[LIBRERIA].[dbo].[MONEDAS] M;
  ...
  INSERT INTO TARIFAS
    ...
    FROM [10.110.21.9].[LIBRERIA].[dbo].[TARIFASVENTA] T;
  ...
  INSERT INTO PRECIOSVENTA
    SELECT
     ...
     ,PV.FECHAMODIFICADO
     ,PV.DESCATALOGADO
    FROM [10.110.21.9].[LIBRERIA].[dbo].[PRECIOSVENTA] PV;
  ...
  INSERT INTO TIPOSPAGO
    SELECT
     ...
     ,TP.METALICO
     ,TP.TARJETA
    FROM [10.110.21.9].[LIBRERIA].[dbo].[TIPOSPAGO] TP;
  ...
  INSERT INTO FORMASPAGO
    SELECT
     ...
     ,FP.CODMONEDA
     ,FP.VISIBLEFRONT
    FROM [10.110.21.9].[LIBRERIA].[dbo].[FORMASPAGO] FP;
  ...
  INSERT INTO VENCIMFPAGO
    ...
    FROM [10.110.21.9].[LIBRERIA].[dbo].[VENCIMFPAGO] VP;
  ...
  INSERT INTO VENDEDORES
    SELECT
     ...
     ,V.ACTIVO
     ,V.DESCATALOGADO
    FROM [10.110.21.9].[LIBRERIA].[dbo].[VENDEDORES] V;
  ...
  INSERT INTO DEPARTAMENTO
    ...
    FROM [10.110.21.9].[LIBRERIA].[dbo].[DEPARTAMENTO] D;
  ...
  INSERT INTO SECCIONES
    ...
    FROM [10.110.21.9].[LIBRERIA].[dbo].[SECCIONES] S;
  ...
  INSERT INTO FAMILIAS
    ...
    FROM [10.110.21.9].[LIBRERIA].[dbo].[FAMILIAS] F;
  ...
  INSERT INTO SUBFAMILIAS
    ...
    FROM [10.110.21.9].[LIBRERIA].[dbo].[SUBFAMILIAS] SF;
  ...
  INSERT INTO MARCA
    ...
    FROM [10.110.21.9].[LIBRERIA].[dbo].[MARCA] M;
  ...
  INSERT INTO LINEA
    ...
    FROM [10.110.21.9].[LIBRERIA].[dbo].[LINEA] L;
  ...
  INSERT INTO ARTICULOS
    SELECT
     ...
     ,0 AS ULTIMO_COSTO
     ,0 AS COSTO_PROMEDIO
    FROM [10.110.21.9].[LIBRERIA].[dbo].[ARTICULOS] A;
  ...
  INSERT INTO IMPUESTOS
    SELECT
     ...
     ,I.IVA
     ,I.REQ AS RECARGO
    FROM [10.110.21.9].[LIBRERIA].[dbo].[IMPUESTOS] I;
  ...
  INSERT INTO TIPOSERVICIOSDELIVERY
    SELECT
     ...
     ,IMPORTEMINIMO
     ,ACTIVARCASHDRO
    FROM [10.110.21.9].[LIBRERIA].[dbo].[TIPOSERVICIOSDELIVERY];
  ...
  INSERT INTO CLIENTES
    ...
    FROM [10.110.21.9].[LIBRERIA].DBO.CLIENTES;
  ...
  INSERT INTO DBO.ARTICULOSCAMPOSLIBRES
      SELECT 
        2,
             ...
             DESCRIPCION_LARGA,
             DESCRIPCION_VIETA
      FROM [10.110.21.9].[LIBRERIA].DBO.ARTICULOSCAMPOSLIBRES;

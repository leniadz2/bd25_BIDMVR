...
CREATE PROCEDURE [dbo].[sp_stg_maestros_05]
AS
BEGIN
  ...
  INSERT INTO MONEDAS
    ...
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[MONEDAS] M;
  ...
  INSERT INTO TARIFAS
    ...
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[TARIFASVENTA] T;
  ...
  INSERT INTO PRECIOSVENTA
    SELECT
     ...
     ,PV.FECHAMODIFICADO
     ,PV.DESCATALOGADO
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[PRECIOSVENTA] PV;
  ...
  INSERT INTO TIPOSPAGO
    SELECT
     ...
     ,TP.METALICO
     ,TP.TARJETA
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[TIPOSPAGO] TP;
  ...
  INSERT INTO FORMASPAGO
    SELECT
     ...
     ,FP.CODMONEDA
     ,FP.VISIBLEFRONT
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[FORMASPAGO] FP;
  ...
  INSERT INTO VENCIMFPAGO
    ...
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[VENCIMFPAGO] VP;
  ...
  INSERT INTO VENDEDORES
    SELECT
     ...
     ,V.ACTIVO
     ,V.DESCATALOGADO
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[VENDEDORES] V;
  ...
  INSERT INTO DEPARTAMENTO
    ...
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[DEPARTAMENTO] D;
  ...
  INSERT INTO SECCIONES
    ...
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[SECCIONES] S;
  ...
  INSERT INTO FAMILIAS
    ...
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[FAMILIAS] F;
  ...
  INSERT INTO SUBFAMILIAS
    ...
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[SUBFAMILIAS] SF;
  ...
  INSERT INTO MARCA
    ...
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[MARCA] M;
  ...
  INSERT INTO LINEA
    ...
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[LINEA] L;
  ...
  INSERT INTO ARTICULOS
    SELECT
     ...
     ,0 AS ULTIMO_COSTO
     ,0 AS COSTO_PROMEDIO
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[ARTICULOS] A;
  ...
  INSERT INTO IMPUESTOS
    SELECT
     ...
     ,I.IVA
     ,I.REQ AS RECARGO
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[IMPUESTOS] I;
  ...
  INSERT INTO TIPOSERVICIOSDELIVERY
    SELECT
     ...
     ,IMPORTEMINIMO
     ,ACTIVARCASHDRO
    FROM [10.110.21.9].[MEDITERRANEO].[dbo].[TIPOSERVICIOSDELIVERY];
  ...
  INSERT INTO CLIENTES
    ...
    FROM [10.110.21.9].[MEDITERRANEO].DBO.CLIENTES;
  ...
  INSERT INTO DBO.ARTICULOSCAMPOSLIBRES
      SELECT 5,
             ...
             DESCRIPCION_LARGA,
             DESCRIPCION_VIETA
      FROM [10.110.21.9].[MEDITERRANEO].DBO.ARTICULOSCAMPOSLIBRES;

...
CREATE INDEX [IX1_VENTASDET_V]
  ON [dbo].[VENTASDET_V] ([COD_EMPRESA], [FECHA])
  ON [PRIMARY]
GO

CREATE INDEX [IX2_VENTASDET_V]
  ON [dbo].[VENTASDET_V] ([FECHA])
  ON [PRIMARY]
GO

CREATE INDEX [IX3_VENTASDET_V]
  ON [dbo].[VENTASDET_V] ([NUMSERIE])
  ON [PRIMARY]
GO